...
$status_str = $user->status_str();
$connection_str = ($user->is_connected())  ? '<div class="col-md-6 form-text-success">Connected</div>' : '<div class="col-md-6 form-text-danger">Disconnected'.(($status_str !== "") ? "- ".$status_str : "").'</div>';
